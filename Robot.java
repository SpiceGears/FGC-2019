...
@TeleOp(name="FGC 2019 official", group="Pushbot")
public class Robot extends OpMode{
    ...
    */
    ...
    public void driveToTarget() {
        ...
        // error = actualAngle - targetAngle;
        // if(Math.abs(error) >5) {
        //     config.leftDrive.setPower(error/40);
        //     config.rightDrive.setPower(-error/40);
        // }else if(Math.abs(error) < 5) {
        //     if(error > 0) {
        //         config.leftDrive.setPower(0.2);
        //         config.rightDrive.setPower(-0.2);
        //     }else if(error < 0) {
        //         config.leftDrive.setPower(-0.2);
        //         config.rightDrive.setPower(0.2);
        //     }else if(error == 0) {
        ...
        // telemetry.addData("anglePower",config.leftDrive.getPower());
    }
